    ...
    <nav className="topnavbar">
      {appState?.user && (
        <div className="cart">
          <link
            ...
            rel="stylesheet"
          />
          <i onClick={() => setIsOpen(true)} className="material-icons md-36">
            add_shopping_cart
          </i>
        </div>
      )}
      ...
      {appState.isAuthenticated ? (
        <div className="authenticated-buttons">
          <button className="button-log" onClick={routeToLogout}>
            {" "}
            Log Out
          </button>
        ...
        <div className="access-buttons">
          <button className="button-log access-button1" onClick={routeToLogin}>
            {" "}
            Log In
          </button>
          <button
            className="button-log access-button2"
